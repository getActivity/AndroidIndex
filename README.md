...
* [Android Studio 和 Gradle 版本关系表](https://developer.android.google.cn/studio/releases/gradle-plugin#updating-gradle)
...
* [XML、JSON 互转](https://www.bejson.com/xml2json/)

* [JSON 生成 Java 实体类](https://www.bejson.com/json2javapojo/new/)

#### 日常开发实用网站

* [二维码在线生成](https://cli.im/)

* [一键提取图片中的文字](https://app.xunjiepdf.com/ocr/)

* [AES加密/解密](https://the-x.cn/cryptography/Aes.aspx)

* [在线字数统计](http://www.txttool.com/t/?id=MzI0)

* [在线文本比较工具](https://www.qianbo.com.cn/Tool/Text-Difference/)

* [时间戳转日期工具](https://try8.cn/tool/time/convert)

* [正则表达式在线测试](https://c.runoob.com/front-end/854/)

* [英文字母大小写转换](https://try8.cn/tool/unit/letter)

* [人民币大写在线转换工具](https://try8.cn/tool/unit/rmb)

* [URL编码/解码](https://try8.cn/tool/code/url)

* [Unicode编码/解码](https://try8.cn/tool/code/unicode)
...
* [图片转 JPG 格式](https://app.xunjiepdf.com/img2jpg/)

* [图片转 PNG 格式](https://app.xunjiepdf.com/img2png/)

* [MP4 转 GIF 格式](https://app.xunjiepdf.com/video2gif/)

* [语音转文字](https://app.xunjiepdf.com/voice2text/)
...
* [HTTP 响应头和请求头信息对照表](http://tools.jb51.net/table/http_header)
